...
public class GoodsTemplate implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 6667417461449055004L;
  ...
  public String toString() {
    return "GoodsTemplate [goodsTemplateId=" + goodsTemplateId + ", goodsName=" + goodsName + ", littlePic=" + littlePic
        + ", goodsType=" + goodsType + ", price=" + price + ", total=" + total + ", unitPrice=" + unitPrice
        + ", goodsContent=" + goodsContent + ", memo=" + memo + ", previewPicFirst=" + previewPicFirst
        + ", previewPicSecond=" + previewPicSecond + ", previewPicThird=" + previewPicThird + ", previewPicFourth="
        + previewPicFourth + ", previewPicFifth=" + previewPicFifth + ", detailPicFirst=" + detailPicFirst
        + ", detailPicSecond=" + detailPicSecond + ", detailPicThird=" + detailPicThird + ", detailPicFourth="
        + detailPicFourth + ", detailPicFifth=" + detailPicFifth + ", detailPicSixth=" + detailPicSixth
        + ", detailPicSeventh=" + detailPicSeventh + ", detailPicEighth=" + detailPicEighth + ", detailPicNinth="
        + detailPicNinth + ", detailPicTenth=" + detailPicTenth + ", stock=" + stock + ", insertTime=" + insertTime
